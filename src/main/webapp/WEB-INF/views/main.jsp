	                    ...
	                    <div class="col-sm-2">
	                        <div class="card product-box">
	                            <div class="product-img">
	                                <div class="p-3">
	                                	<a href="/shop/items/detail/${row.itemNo}"></a>
	                                    <img src="../resources/static/assets/images/products/{row.itemImage}" alt="product-pic" class="img-fluid" />
	                                </div>
                                ...
                                <div>
                                    ...
                                    <a href="/shop/items/detail/${row.itemNo}" class="text-dark">${row.itemName}</a> </h5>
                                    <h4 class="m-0"> <span class="text-muted"> Price : <fmt:formatNumber value="${row.itemPrice }" pattern="###,###,###"/></span></h4>
                                </div>
